...
(function(window, undefined) {
    ...
    _extend(KCmd, {
        ...
        insertimage: function(url, title, width, height, border, align) {
            ...
            var html = '<p class="pic" style="text-align:center;"><img src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" ';
            // 拼图片
            if (width) {
            ...
            html += '/>';
            // 图标标注
            html = html + '<span>' + _escape(title) + '</span>';
    ...
    _plugin('core', function(K) {
        ...
        self.beforeGetHtml(function(html) {
            ...
            return html.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/ig, function($0, $1, $2, $3) {
                ...
                .replace(/(<img[^>]*)src="([^"]*)"([^>]*>)/ig, function(full, start, src, end) {
                    if (full.match(/\sdata-lazyload="[^"]*"/i)) {
                        return full;
                    }
                    full = start + 'src="' + _escape(src) + '" data-lazyload="' + _escape(src) + '"' + end;
                    return full;
                })
        ...
        self.beforeSetHtml(function(html) {
            ...
            return html.replace(/<embed[^>]*type="([^"]+)"[^>]*>(?:<\/embed>)?/ig, function(full) {
                ...
                // .replace(/(<img[^>]*)data-lazyload="([^"]*)"([^>]*>)/ig, function(full, start, src, end) {
                //     if (full.match(/\ssrc="[^"]*"/i)) {
                //         return full;
                //     }
                //     full = start + 'src="' + _escape(src) + '"' + end;
                //     return full;
                // })
